...
2) Add an alias (called **/theme**) to download themes without typing the full URL, type:<br>
`alias -add /theme cd /storage/emulated/0/t-ui/THEMES && curl -LJO https://github.com/M4dGun/t-ui_themes/raw/main/database/% && cd /storage/emulated/0/`
