...
install_theme(){
	...
	then
		...
		echo "ttm=sh $sd/$FILENAME %" >> $ALIASTXT
		echo "ttm -p=search -u https://github.com/M4dGun/t-ui_themes" >> $ALIASTXT
		printf "\n \n :: Added ttm alias in new alias.txt " ; printf " \n" ; sleep 1.5
	else
		...
		echo " ttm alias already exists, nothing to change "
		printf "\n \n :: ttm alias already exists, nothing to change " ; printf " \n" ; sleep 1.5
	fi
	
	printf "\n :: THEME INSTALLED! :: " ; printf " \n" ; sleep 1.5
